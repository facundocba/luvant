...
const LENS_FEATURES = [
  {
    ...
    title: "Multi-format",
    description:
      "Invoices, medical prescriptions, forms, contracts, delivery notes, and any structured or semi-structured document.",
  },
  {
    icon: <Zap size={22} strokeWidth={1.5} />,
    title: "Parallel processing",
    description:
      "Thousands of documents per hour. Batch processing with intelligent queues and automatic prioritization.",
  },
  {
    icon: <Shield size={22} strokeWidth={1.5} />,
    title: "Automatic validation",
    description:
      "Cross-check of extracted data against business rules. Alerts when something doesn't add up.",
  },
  {
    icon: <Code size={22} strokeWidth={1.5} />,
    title: "Simple REST API",
    description:
      "Single endpoint, structured JSON response. SDKs for Python, Node.js, and .NET.",
  },
  {
    icon: <Languages size={22} strokeWidth={1.5} />,
    title: "Optimized for Spanish",
    description:
      "Models trained with Argentine and Latin American documents. Understands local CUIT, date, and currency formats.",
  },
  {
    icon: <FileCheck size={22} strokeWidth={1.5} />,
    title: "Customizable fields",
    description:
      "Define which data to extract from each document type. Reusable templates for your workflow.",
  },
];
...
const PROCESS_STEPS = [
  {
    ...
    description:
      "PDF, image, or photo from your phone. Lens accepts any format and quality.",
  },
  {
    step: "02",
    title: "Lens analyzes and extracts",
    description:
      "OCR + ML identifies fields, tables, and relationships. Results in under 500ms.",
  },
  {
    step: "03",
    title: "You receive structured data",
    description:
      "Clean JSON with each field, its value, and confidence level. Ready for your system.",
  },
];
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/[0.08] bg-luvant-900/80">
        ...
        <div className="p-5 font-mono text-xs leading-relaxed">
          ...
          >
            {"// Response — invoice_0003-00018742.pdf"}
          </motion.div>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
              ...
              <div>
                ...
                >
                  <Badge variant="accent" className="mb-6">
                    OCR &middot; Documents &middot; ML
                  </Badge>
                </motion.div>
                ...
                >
                  Transform physical and digital documents into structured data
                  with enterprise-grade accuracy. No manual intervention, no
                  data entry errors.
                </motion.p>
          ...
          <Container className="relative">
            ...
            >
              ...
              <h2 className="text-h2 md:text-h1 mb-4">
                Built for{" "}
                <span className="text-gradient-bright">production</span>
              </h2>
              <p className="max-w-xl text-body text-luvant-400">
                Not a prototype. Lens is designed to handle real-world volumes
                with the reliability your operation demands.
              </p>
            </motion.div>
          ...
          <Container className="relative text-center">
            ...
            >
              ...
              <p className="mx-auto mt-4 max-w-md text-body text-luvant-400">
                Schedule a demo with your real documents and measure the results
                yourself.
              </p>
